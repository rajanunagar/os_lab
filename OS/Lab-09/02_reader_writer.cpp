...
sem_t common_mutex, write_mutex, read_mutex;
int reader_count;
int writer_count;
...
void *Writer(void *t)
{
    ...
    writer_count ++;
    if(1 == writer_count)
        sem_wait(&common_mutex);
    sem_post(&write_mutex);

    cout << "Writer is Writing : " <<writer_count<<"\n";
...
void *Reader(void *t)
{
    ...
    cout << "Reader is Reading : " << reader_count << endl;
